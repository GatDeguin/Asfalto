...
const {startServer}=await import('../server.mjs?v=balance-20260917');const server=await startServer({root:path.resolve('Asfalto_Nacional_v7'),port:0,cockpitDataDirectory:path.join(out,'isolated-data')});
