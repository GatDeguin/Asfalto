...
const {startServer}=await import('../server.mjs?v=400-review-r144-20260917');const server=await startServer({root:path.resolve('Asfalto_Nacional_v7'),port:0,cockpitDataDirectory:path.join(out,'isolated-data')});
