...
const {startServer}=await import('../server.mjs?v=full-r1-20260916');const server=await startServer({root:path.resolve('Asfalto_Nacional_v7'),port:0,cockpitDataDirectory:path.join(out,'isolated-data')});
