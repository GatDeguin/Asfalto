...
function setup({shared=Promise.resolve(true),prepared=Promise.resolve({drivingBuffers:[]})}={}){
 let nodes=0,preparations=0,signal;const context={state:'running',destination:{},createGain(){nodes++;return{gain:{value:0},connect(){},disconnect(){}}},resume:async()=>{}};
