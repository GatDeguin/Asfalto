# Asfalto Nacional V6 para GitHub Pages
...
Publicación: Settings → Pages → Deploy from a branch → main → / (root). El archivo .nojekyll permite servir los módulos y recursos tal como están. Para ejecutar una copia local, usar INICIAR_JUEGO.bat o node server.mjs.
