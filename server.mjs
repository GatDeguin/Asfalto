...
import { createCockpitLayoutEndpoint } from './src/server/cockpit-layout-store.mjs?v=body-r2-20260916';
import {createLightingPresetEndpoint} from './src/server/lighting-preset-store.mjs?v=body-r2-20260916';
