...
import {createDosLagosAdapter} from "../tracks/adapters/dos-lagos.mjs?v=photo-r1-20260916";
import {createAconcaguaHorconesAdapter} from "../tracks/adapters/aconcagua-horcones.mjs?v=photo-r1-20260916";
import {createCuestaLipanAdapter} from "../tracks/adapters/cuesta-lipan.mjs?v=photo-r1-20260916";
import {createPasoGaribaldiAdapter} from "../tracks/adapters/paso-garibaldi.mjs?v=photo-r1-20260916";

import {createIguazuAdapter} from "../tracks/adapters/cataratas-iguazu.mjs?v=photo-r1-20260916";
