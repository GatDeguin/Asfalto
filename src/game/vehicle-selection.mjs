...
export function createVehicleSelection({initial='chevy',ids=Object.values(VEHICLE_CATALOG).filter(vehicle=>vehicle.selectable).map(vehicle=>vehicle.id),prepare,storage=globalThis.localStorage,onState=()=>{}}={}) {
