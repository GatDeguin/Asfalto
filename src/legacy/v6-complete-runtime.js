...
const phoneMemoryReady=import(new URL('src/runtime/phone-start-memory.mjs?v=full-r1-20260916',document.baseURI));
...
async function loadChampionshipMenu(){
 ...
 return championshipMenuPromise||(championshipMenuPromise=import(new URL('src/menu/v7-championship-menu.mjs?v=full-r1-20260916',document.baseURI)).then(m=>{
...
function loadCollectionReader(){return collectionReaderPromise||(collectionReaderPromise=import(new URL('src/menu/v7-earned-collection.mjs?v=full-r1-20260916',document.baseURI)).catch(error=>{collectionReaderPromise=null;throw error;}));}
...
async function loadRoadTestTools(){
 ...
 return roadTestToolsPromise||(roadTestToolsPromise=Promise.all([import(new URL('src/menu/v7-roadtest-session.mjs?v=full-r1-20260916',document.baseURI)),import(new URL('src/menu/v7-roadtest-profile.mjs?v=full-r1-20260916',document.baseURI))]).then(([session,store])=>{
...
async function initV6(){
 ...
 const {createVehicleMaintenance}=await import(new URL('src/game/vehicle-maintenance.mjs?v=full-r1-20260916',document.baseURI));
