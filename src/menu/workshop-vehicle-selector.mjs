import {createVehicleSelection} from '../game/vehicle-selection.mjs?v=photo-r1-20260916';
import {VEHICLE_CATALOG} from '../render/vehicle-catalog.mjs?v=photo-r1-20260916';
