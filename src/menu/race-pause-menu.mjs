...
export function createRacePauseMenu({
  ...
  overlay.innerHTML = `<div class="an-pause-shell">
    <header class="an-pause-brand"><img class="an-pause-brand-logo" src="${new URL('../../assets/brand/asfalto-nacional-v7.webp?v=180789eed4e70f3a', import.meta.url).href}" alt="Asfalto Nacional" width="540" height="180"><small data-selected-vehicle-label>Vehículo seleccionado</small></header>
