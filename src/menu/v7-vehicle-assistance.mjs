import {createRolloverDetector} from '../game/rollover-detection.mjs?v=1cf152a1e215f4e6';
export function mountVehicleAssistance({document=globalThis.document,onRecover,onWorkshop}){
 ...
 const link=document.createElement('link');link.rel='stylesheet';link.href=new URL('../../assets/styles/vehicle-assistance.css?v=8004e6e4c9bc0acf',import.meta.url).href;document.head.append(link);document.body.append(node);
