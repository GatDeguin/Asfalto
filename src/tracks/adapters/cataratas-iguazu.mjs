import { createGlbPointToPointAdapter } from './glb-point-to-point.mjs?v=body-r3-20260916';
import { createClosedRoute } from '../visuals/route-closure.mjs?v=body-r3-20260916';
import { prepareIguazuVisual, prepareIguazuReturn } from '../visuals/iguazu-landscape.mjs?v=body-r3-20260916';
