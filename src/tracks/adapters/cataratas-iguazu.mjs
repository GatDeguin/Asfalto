import { createGlbPointToPointAdapter } from './glb-point-to-point.mjs';
import { createClosedRoute } from '../visuals/route-closure.mjs';
import { prepareIguazuVisual, prepareIguazuReturn } from '../visuals/iguazu-landscape.mjs';
