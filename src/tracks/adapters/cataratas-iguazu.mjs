...
import { createClosedRoute } from '../visuals/route-closure.mjs?v=afe90245eed77656';
import { prepareIguazuVisual, prepareIguazuReturn } from '../visuals/iguazu-landscape.mjs?v=0df862d6311d6264';
