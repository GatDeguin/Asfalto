import { createGlbPointToPointAdapter } from './glb-point-to-point.mjs?v=full-r1-20260916';
import { createClosedRoute } from '../visuals/route-closure.mjs?v=full-r1-20260916';
import { prepareIguazuVisual, prepareIguazuReturn } from '../visuals/iguazu-landscape.mjs?v=full-r1-20260916';
