...
import { createClosedRoute } from '../visuals/route-closure.mjs?v=balance-20260917';
import { prepareIguazuVisual, prepareIguazuReturn } from '../visuals/iguazu-landscape.mjs?v=balance-20260917';
