...
import { createClosedRoute } from '../visuals/route-closure.mjs?v=body-r2-20260916';
import { prepareIguazuVisual, prepareIguazuReturn } from '../visuals/iguazu-landscape.mjs?v=body-r2-20260916';
