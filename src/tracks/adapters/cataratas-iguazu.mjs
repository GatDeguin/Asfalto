...
import { createClosedRoute } from '../visuals/route-closure.mjs?v=bf230a805014e68f';
import { prepareIguazuVisual, prepareIguazuReturn } from '../visuals/iguazu-landscape.mjs?v=dafdb7f0aa912eb7';
