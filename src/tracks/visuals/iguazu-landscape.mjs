import {prepareIguazuSurfaces} from './reference-landscape.mjs?v=c4762a953cda2b57';
...
import {findWaterfallImpact} from './waterfall-impact.mjs?v=35b9296e0afffa6f';
...
export async function prepareIguazuReturn(root,{sourceRoot,query,startM,lengthM,THREE:T=globalThis.__chevyV6Three||globalThis.THREE}={}){
  ...
  const {terrainHeightSampler}=await import('./reference-landscape.mjs?v=c4762a953cda2b57'),heightAt=terrainHeightSampler(T,root),items=[],dummy=new T.Object3D();let count=0;
