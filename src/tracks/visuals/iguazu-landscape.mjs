...
import {prepareIguazuSurfaces,terrainHeightSampler} from './reference-landscape.mjs?v=full-r1-20260916';
import {applySurfaceVertexColors} from './surface-vertex-colors.mjs';
import {installSharedInstanceWindow} from '../seam-copy-factory.mjs?v=full-r1-20260916';
...
export async function prepareIguazuReturn(root,{sourceRoot,query,startM,lengthM,THREE:T=globalThis.__chevyV6Three||globalThis.THREE}={}){
  ...
  const {terrainHeightSampler}=await import('./reference-landscape.mjs?v=full-r1-20260916'),heightAt=terrainHeightSampler(T,root),items=[],dummy=new T.Object3D();let count=0;
