...
import { createWorkshopDetailPass, applyPatina } from './workshop-detail-pass.mjs?v=097bdcbdc46a6973';
import { createWorkshopStaticBatches } from './workshop-static-batches.mjs';
import { configureSurfaceRelief, installSurfaceRelief, surfaceReliefDiagnostics } from '../tracks/visuals/surface-relief.mjs?v=cd94870ee4671a7f';
