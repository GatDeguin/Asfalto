// Adapted from Three.js r180 Reflector. MIT license; see THREE-LICENSE.txt.
// Dependency injected to share the existing game renderer module instance.
export function reflectorClass(THREE) {
const {
	Color,
	Matrix4,
	Mesh,
