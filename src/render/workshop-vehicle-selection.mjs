import {createVehiclePresentation} from './vehicle-presentation.mjs?v=body-r2-20260916';
import {createWorkshopInspection} from './workshop-inspection.mjs';
import {createWorkshopChassis} from './workshop-chassis.mjs';
import {createWorkshopEngine} from './workshop-engine.mjs?v=body-r2-20260916';
