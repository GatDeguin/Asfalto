...
import {createPivotPainter}from'./pivot-painter.mjs?v=full-r1-20260916';
...
import {createScreenSpaceLighting,screenLightingPolicy}from'./screen-space-lighting.mjs?v=full-r1-20260916';
