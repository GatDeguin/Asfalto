import {createAdvancedMaterials}from'./advanced-materials.mjs?v=photo-r1-20260916';
import {createPivotPainter}from'./pivot-painter.mjs?v=photo-r1-20260916';
...
import {createScreenSpaceLighting,screenLightingPolicy}from'./screen-space-lighting.mjs?v=photo-r1-20260916';
