...
export async function createVehiclePresentation(T,{vehicle='chevy',modelRoot,loadGlb,signal,lodLevels=[0,1,2],...options}={}) {
  ...
  try {
    for(const level of lodLevels) {
      ...
      url.searchParams.set('v','body-r2-20260916');
