// Three.js GLTFLoader, MIT. Bundled from the supplied Motor_Chevy_250 viewer.
const cache=new WeakMap();
export function engineGLTFLoaderClass(T){if(cache.has(T))return cache.get(T);const create=()=>{
const {
	AnimationClip,
	Bone,
	Box3,
...
};const Loader=create();cache.set(T,Loader);return Loader;}
