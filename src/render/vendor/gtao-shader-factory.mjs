// Three.js r180 GTAO, MIT license. Adapted to the caller-owned Three namespace.
export function gtaoShaderDefinitions(THREE) {
const {
	DataTexture,
	Matrix4,
	RepeatWrapping,
...
return {generateMagicSquareNoise,GTAOShader,GTAODepthShader,GTAOBlendShader};
}
