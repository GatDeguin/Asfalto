...
import { sanitizeCompositionState } from '../game/composition-editor-state.mjs?v=photo-r1-20260916';
import { COCKPIT_LENS_PRESETS } from '../game/vehicle-camera-rig.mjs?v=photo-r1-20260916';
