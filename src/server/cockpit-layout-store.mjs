...
import { sanitizeCompositionState } from '../game/composition-editor-state.mjs?v=body-r2-20260916';
import { COCKPIT_LENS_PRESETS } from '../game/vehicle-camera-rig.mjs?v=body-r2-20260916';
